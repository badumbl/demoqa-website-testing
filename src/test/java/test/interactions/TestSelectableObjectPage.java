...
import pageObjects.interactions.SelectableObjectPage;
import test.BaseTest;

import java.util.Arrays;

public class TestSelectableObjectPage extends BaseTest {

    private SelectableObjectPage selectablePage;
    ...
    @BeforeClass
    public void init() {
        selectablePage = new SelectableObjectPage(driver);
    }
